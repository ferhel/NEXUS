...
import { clasificar } from "../lib/nexusModel";
...
export default function CamaraConcentracion({ activa = true, onEstadoChange, onMuestra }) {
  const { t } = useTheme();
  ...
  // re-renderiza con una nueva identidad de función (ej. cada segundo por el timer del pomodoro)
  const onMuestraRef = useRef(onMuestra);
  useEffect(() => { onMuestraRef.current = onMuestra; }, [onMuestra]);
