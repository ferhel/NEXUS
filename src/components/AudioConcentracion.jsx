...
// ─────────────────────────────────────────────────────────────
// AudioConcentracion — Generador de ambiente sensorial Nexus
// Optimizado: Enlaces directos a Spotify + Ruido Marrón Nativo
// ─────────────────────────────────────────────────────────────

function crearModos(t) {
  return [
    {
      id: "spotify_lofi",
      label: "Lofi Focus",
    ...
    <div style={{
      ...
      <div onClick={() => setExpandido(e => !e)} style={{ display: "flex", alignItems: "center", gap: 14, cursor: "pointer" }}>
        <div style={{
          ...
          background: modoActivo ? (modoInfo?.colorSoft || t.accentSoft) : t.bgMuted,
          border: `1px solid ${modoActivo ? (modoInfo?.color || t.accent) : t.border}`,
